            ...
            <div class="p-6">
                ...
                <div class="flex gap-2">
                    <button onclick="openQuoteModal('${p.nombre}')"
                        class="flex-1 font-mono text-[9px] uppercase tracking-widest bg-alumic-blue py-3 text-white hover:bg-blue-700 transition-all font-bold">
                        Cotizar
                    </button>
                    <a href="https://wa.me/5492614542257?text=Hola%20Alumic%2C%20me%20interesa%20el%20producto%3A%20${encodeURIComponent(p.nombre)}"
                        target="_blank"
                        class="font-mono text-[9px] uppercase tracking-widest border border-alumic-steel px-3 py-3 text-slate-500 hover:border-alumic-blue hover:text-alumic-blue transition-all">
